	...
	public MainGUI() {
		...
		comboBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(comboBox.getSelectedItem().equals("Aritz Plazaola")) textArea.setText(queries.getAritzQueryText().get(actualIndex));
				if(comboBox.getSelectedItem().equals("Zdravko Todorov")) textArea.setText(queries.getZdravkoQueryText().get(actualIndex));
			}
		});
		...
		model.addElement("talking to earth");
		...
		btnNextQuery.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(actualIndex < 2) actualIndex++;
				if(comboBox.getSelectedItem().equals("Aritz Plazaola") && actualIndex < 3) textArea.setText(queries.getAritzQueryText().get(actualIndex));
				if(comboBox.getSelectedItem().equals("Zdravko Todorov") && actualIndex < 3) textArea.setText(queries.getZdravkoQueryText().get(actualIndex));
			}
		});
		...
		btnPreviousQuery.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(comboBox.getSelectedItem().equals("Aritz Plazaola") && actualIndex >= 0) textArea.setText(queries.getAritzQueryText().get(actualIndex));
				if(comboBox.getSelectedItem().equals("Zdravko Todorov") && actualIndex >= 0) textArea.setText(queries.getZdravkoQueryText().get(actualIndex));
			}
		});
